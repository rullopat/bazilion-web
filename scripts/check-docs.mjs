...
for (const slug of ['operations', 'backup-recovery', 'private-access', 'results', 'conversations', 'follow-up-queue', 'questions', 'attention-notifications', 'coding-environment', 'coding-review', 'coding-verification', 'coding-review-packets']) {
