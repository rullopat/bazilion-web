...
Use the matching old release to recover/export work first. Version 0.17.0 changes the schema;
an older-schema backup cannot migrate into it. See [upgrading](/docs/getting-started/#upgrade-to-0170).
